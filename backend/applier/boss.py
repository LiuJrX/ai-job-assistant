...
from backend.applier.captcha import detect_captcha, notify_captcha
from backend.applier.history import ApplyHistory
from backend.config import Settings
from backend.models import Application, ApplicationStatus, Job, JobSource
...
class BossApplier(BaseApplier):
    ...
    async def __aenter__(self) -> Self:
        ...
        logger.info(
            "BossApplier browser launched (headless=%s)",
            self._settings.jobclaw_headless,
        )
        return self
